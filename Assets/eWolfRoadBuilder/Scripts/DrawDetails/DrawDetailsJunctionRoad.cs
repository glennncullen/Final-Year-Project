...
{
    /// <summary>
    /// The Junction road draw details
    /// </summary>
    public sealed class DrawDetailsJunctionRoad : IDrawDetails
    {
        /// <summary>
        ...
        public DrawDetailsJunctionRoad(int connectionSet, RoadNetworkNode roadNetworkNode, string materialName)
        {
        ...
        public void DrawMesh(IRoadBuildData roadBuilderObject)
        {
            ...
            MeshBuilderJunction jb = new MeshBuilderJunction(
                roadBuilderObject,
                list,
                _roadNetworkNode,
                _materialName);
