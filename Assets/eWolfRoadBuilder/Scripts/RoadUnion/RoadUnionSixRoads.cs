...
{
    /// <summary>
    /// Six Road Union class
    /// </summary>
    public class RoadUnionSixRoads : IRoadUnion
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="node">The node</param>
        public RoadUnionSixRoads(RoadNetworkNode node)
        {
        ...
        public void CreateLayout(RoadBuilder roadBuilderObject)
        {
            ...
            if (_roadNetworkNode.Details.Roads[4] == null)
                return;
            if (_roadNetworkNode.Details.Roads[5] == null)
                return;

            CreateSixRoads(roadBuilderObject, _roadNetworkNode.Details.Sections);
        }
        ...
        {
            CreateSixRoadsTerrain(_roadNetworkNode.Details.Sections, tm);
        }
        #endregion
        ...
        private void CreateSixRoads(RoadBuilder roadObject, int sections)
        {
            ...
            StreetManager.Instance.AddStreetEnd(_roadNetworkNode.name, _roadNetworkNode.Details.Roads[5].name, RoadConstructorHelper.CrossSection(_roadNetworkNode.Details.Roads[5]), RoadConstructorHelper.Materials(roadE), rF);
            ...
            RoadCrossSection rscF = IntersectionManager.Instance[list[5]];
            ...
            StreetManager.Instance.ReplaceRoadWithId(_roadNetworkNode.name, _roadNetworkNode.Details.Roads[5].name,
                RoadConstructorHelper.CrossSection(_roadNetworkNode.Details.Roads[5]), rscF);
        }
